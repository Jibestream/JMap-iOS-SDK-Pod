...
#ifndef JMAPCOREKIT_SWIFT_H
#define JMAPCOREKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="JMapCoreKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///
/// \param completionHandler A callback with JMapWaypoint of the nearest searched element to the point in search, searched element and JMapError. 
///
